...
class ImageReader(object):
    ...
    def __next__(self):
        if self.idx == self.max_idx:
            raise StopIteration
        print("img path:",self.file_names[self.idx])
...
if __name__ == '__main__':
    ...
    #frame_provider = ImageReader("./test_imgs")
    #if args.video != '':
    ...
    track=1
    smooth=1
    run_demo(net,"./test_imgs" , height_size, cpu, track, smooth)
